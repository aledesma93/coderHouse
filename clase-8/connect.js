...
//conecto con sqlite
const knex = require("knex")({client: "sqlite3",connection: {filename: "./db/mydb.sqlite",},useNullAsDefault: true,});
const products = [
...
// knex.schema
//   .createTable('pruebasClase', (table) => {
//     table.increments('id'), table.string('name'), table.integer('price'), table.integer('stock');
//   })
//   .then(() => {
